    ...
    def build_system_prompt(
        ...
        if language == "ar":
            instructions = (
                ...
                "- اللغة: أجب بالعربية افتراضياً. إذا طلب المستخدم صراحةً الإجابة بلغة أخرى "
                "(مثل 'explain in English' أو 'in English'), فأجب بتلك اللغة — لا ترفض. "
                "اختيار لغة الإجابة لا يغيّر المستندات التي تستطيع الاستشهاد بها.\n\n"
            ...
            instructions = (
                ...
                "- LANGUAGE: respond in English by default. If the user explicitly "
                "asks for a response in another language (e.g. 'explain in Arabic', "
                "'in Arabic', 'باللغة العربية'), provide the answer in that language "
                "— do NOT refuse. The choice of response language does not change which "
                "documents you can cite or what you can explain.\n\n"
